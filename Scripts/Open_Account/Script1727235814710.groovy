...
WebUI.click(findTestObject('Home_Page/OpenNewAcc_btn'))

WebUI.click(findTestObject('OpenAccDetail_Page/OpenNew_AccBtn'))

String accnum = WebUI.getText(findTestObject('OpenAccDetail_Page/Opened_Acc'))

WebUI.click(findTestObject('Home_Page/AccountOverview_Btn'))
